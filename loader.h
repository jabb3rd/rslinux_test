...
typedef bool (*PrepareRouter_t)(dword row, dword ip, word port, dword *hrouter);
typedef bool (*ScanRouter_t)(dword *hrouter);
typedef bool (*FreeRouter_t)(dword *hrouter);
typedef bool (*StopRouter_t)(dword *hrouter);
